# 아.. 아래의 짓보다 더 나은 방법이 [osx 아파치와 톰켓 연동](https://www.bartbusschots.ie/s/2009/05/05/installing-mod_jk-for-apache-22-on-mac-os-x-105-leopard/) 에 소개되어있었다. others 라는 디렉토리가 존재했고 거기에 그냥 두는것이 httpd.conf 를 손대지 않는 가장 좋은 방법이었다!!! 해외글을 읽으시고 그대로 하길 바라며 그 글을 읽고 나면 아래의 내용들에 대해서도 이해가 될 것이다. 아래글은 곧 재정비할 것이니 참고 바란다!!!!  아래에서 참고할만한 내용은 mod_jk 컴파일 정도이다.  
